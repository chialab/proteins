import { isBoolean, isDate, isFalsy, isFunction, isNumber, isObject, isString, isUndefined } from '@chialab/proteins';
import { assert, describe, test } from 'vitest';

describe('Unit: Types', () => {
    test('should recognize Object instances', () => {
        assert(isObject({}));
    ...
    test('should recognize Date instances', () => {
        assert(!isDate({}));
    ...
    test('should recognize String instances', () => {
        assert(!isString({}));
    ...
    test('should recognize Number instances', () => {
        assert(!isNumber({}));
    ...
    test('should recognize Boolean instances', () => {
        assert(!isBoolean({}));
    ...
    test('should recognize Function instances', () => {
        assert(!isFunction({}));
    ...
    test('should recognize undefined values', () => {
        assert(!isUndefined({}));
